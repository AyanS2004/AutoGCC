"""
RAG Engine for GCC Data Chatbot - FAISS Version (Windows Compatible)
Handles vector storage, retrieval, and LLM interaction
Uses FAISS instead of ChromaDB - no C++ build tools required!
"""
...
class GCCDataRAG:
    """RAG system for GCC data interaction - FAISS version"""
